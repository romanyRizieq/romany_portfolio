...
const Home = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(./images/background_black.jpg)',
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center max-w-7xl mx-auto px-6 sm:px-10 space-y-10 lg:space-y-0 lg:space-x-16 pt-24 sm:pt-32">
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          <img
            src="./images/Romany Rizieq (Home).jpeg"
            alt="Romany Rizieq"
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed">
            ...
            an Aerospace Engineer, Frontend Developer, and Automotive Specialist. I combine precision engineering and web creativity to build seamless and innovative experiences.
          </p>

          {/* Action Buttons */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
            <a
              href="./Romany_Rizieq_Resume.pdf"
              download
